...
import { Shield, Target, Crosshair, Sparkles, Lock, AlertTriangle } from 'lucide-react';
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <span className="text-sm text-purple-300">{t('pricing.subtitle')}</span>
          </motion.div>
                    ...
                    {hasValidPricing ? (
                      <>
                        <div className="flex items-baseline mb-4">
                          <span className="text-sm text-gray-400 mr-2">{t('pricing.from')}</span>
                          <span className="text-3xl font-bold text-white">
                            {getPriceInCurrentCurrency(product.pricing[0].price)}
                          </span>
                          <span className="ml-2 text-gray-400">/ {t(`periods.${product.pricing[0].period}`)}</span>
                        </div>
                        <Link 
                          to={`/product/${id}`}
                        ...
                        >
                          <span className="relative z-10">{t('pricing.viewDetails')}</span>
